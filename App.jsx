...
const App = () => {
  ...
  const customStyles = {
    control: (provided) => ({
      ...provided,
      backgroundColor: '#000', // dark background (similar to bg-zinc-900)
      borderColor: '#3f3f46',
      color: '#fff',
      width: "100%"
    }),
      ...
      <div className="main flex justify-between" style={{ height: "calc(100vh - 90px" }}>
        <div className="left h-[87.5%] w-[50%]">
          <div className="tabs !mt-5 !px-5 !mb-3 w-full flex items-center gap-[10px]">
            ...
            <button
                onClick={() => {
                if (code === "") alert("Please enter code first");
                else reviewCode();
                }}
               className="btnNormal">
               Review
        ...
        <div className="right overflow-scroll !p-[10px] bg-zinc-800 w-[50%] h-[101%]">
